  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocListener<AuthBloc, AuthState>(
        ...
        //   return current.isUseAuthenticated != false;
        // },
        // listener: (BuildContext context, AuthState state) {
        //   if (state.isUseAuthenticated) {
        //     debugPrint('User is Authenticated correctly');
        //     context.goNamed(RouteNames.home);
        //   }
        // },
        // buildWhen: (previous, current) {
        //   return previous.isUseAuthenticated != current.isUseAuthenticated;
        // },
        listener: (BuildContext context, AuthState state) {
          debugPrint('OUTSIDE');
          if (state.isUseAuthenticated) {
                ...
                ButtonLong(
                  ...
                  onTap: () {
                    ...
                    if (emailController.text.isNotEmpty &&
                      ...
                      debugPrint('Todo correcto! Llamando a AuthBloc');
